...
const cacheDir = path.join(__dirname, '../node_modules/.cache/optimized-images');
...
async function optimizeImages() {
  try {
    ...
    for (const file of files) {
      ...
      console.log(`Processing ${file}: resizing width from ${metadata.width}px to ${newWidth}px and converting to webp...`);
